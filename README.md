...
*Inspired by and heavily borrowed from the no-longer maintained [pires/elasticsearch](https://github.com/pires/docker-elasticsearch) project*
...
- Alpine 3.10
- JRE 8.212.04-r0
- [ElasticSearch 7.2.0](https://www.elastic.co/guide/en/elasticsearch/reference/7.2/getting-started.html)
